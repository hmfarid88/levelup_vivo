    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            try {
                ...
                String query = "update retailer_info set R_NAME=?, OWNER=?, ADDRESS=?, M_NUMBER=?, EMAIL=?  where  R_NAME=? ";
                ...
                if (a > 0) {
                    String upq="update customerinfo set C_NAME=?, AREA_NAME=?, BOSS_NAME=? where C_NAME=?";
                ps = con.prepareStatement(upq);
                ps.setString(1, retailer);
                ps.setString(2, address);
                ps.setString(3, owner);
                ps.setString(4, oldretailer);
                ps.executeUpdate();
